...
{
  ʽ(TinyIdToUserId paramTinyIdToUserId, IMUserIdListener paramIMUserIdListener)
  {
  ...
  {
    Object localObject1 = new tinyid_to_userid.RspBody();
    Object localObject2;
    try
    {
      ((tinyid_to_userid.RspBody)localObject1).mergeFrom(paramArrayOfByte);
      paramArrayOfByte = getUserIdList();
      localObject1 = ((tinyid_to_userid.RspBody)localObject1).userid.get().iterator();
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      QLog.d("MSF.C.TinyIdToUserId", 1, "get userid: " + localObject2 + "|tinyid: " + ((IMUserId)localObject2).getTinyId());
    }
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\imsdk\userid\ʽ.class
