  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        QLog.d("TIMSnapshot", 1, "downloading from url: " + (String)localObject3);
        localObject3 = (HttpURLConnection)new URL((String)localObject3).openConnection();
        QLog.d("TIMSnapshot", 1, "http resp code: " + ((HttpURLConnection)localObject3).getResponseCode() + "|descr: " + ((HttpURLConnection)localObject3).getResponseMessage());
        if (((HttpURLConnection)localObject3).getResponseCode() != 200)
        {
          ...
          TIMSnapshot.access$000().post(new ˈʼ(this, (String)localObject1));
          return;
        }
      }
      catch (Exception localException1)
      {
        ...
        TIMSnapshot.access$000().post(new ˈʽ(this, localException1));
        return;
      }
      try
      {
      ...
      catch (Exception localException2)
      {
        ...
        TIMSnapshot.access$000().post(new ˈʿ(this, str));
        ((HttpURLConnection)localObject3).disconnect();
        i = j;
        continue;
        localFileOutputStream.close();
        TIMSnapshot.access$000().post(new ˈʾ(this));
        return;
      }
      finally
      {
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\ˈʻ.class
