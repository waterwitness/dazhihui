...
class IBaseActionListener$Stub$a
  implements IBaseActionListener
{
  private IBinder a;
  
  IBaseActionListener$Stub$a(IBinder paramIBinder)
  {
    this.a = paramIBinder;
  }
  ...
  public String a()
  {
    return "com.tencent.qalsdk.base.remote.IBaseActionListener";
  }
  ...
  public void onActionResult(FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   25: aload_0
    //   26: getfield 15	com/tencent/qalsdk/base/remote/IBaseActionListener$Stub$a:a	Landroid/os/IBinder;
    //   29: iconst_2
    //   30: aload_2
    //   31: aconst_null
    //   32: iconst_1
  ...
  public void onResponse(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        localParcel.writeInterfaceToken("com.tencent.qalsdk.base.remote.IBaseActionListener");
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\qalsdk\base\remote\IBaseActionListener$Stub$a.class
