    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((HttpURLConnection)localObject3).getResponseCode() != 200)
        {
          ...
          this.a.b.post(new ˈˊ(this, (String)localObject1));
          return;
        }
      }
      catch (Exception localException1)
      {
        ...
        this.a.b.post(new ˈˋ(this, localException1));
        return;
      }
      try
      {
      ...
      catch (Exception localException2)
      {
        ...
        this.a.b.post(new ˈˏ(this, str));
        ((HttpURLConnection)localObject3).disconnect();
        i = j;
        continue;
        localFileOutputStream.close();
        this.a.b.post(new ˈˎ(this));
        return;
      }
      finally
      {
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\ˈˉ.class
