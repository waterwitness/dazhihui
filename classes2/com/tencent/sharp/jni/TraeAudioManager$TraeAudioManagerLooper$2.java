    ...
    do
    {
      do
      {
        ...
        catch (Exception localException)
        {
          ...
          {
            this.this$1.this$0.InternalConnectDevice(paramMessage, null);
            return;
          }
      ...
      } while (this.this$1.this$0.InternalConnectDevice(paramMessage, null) == 0);
      if (QLog.isColorLevel()) {
      ...
      this.this$1.this$0.InternalConnectDevice(this.this$1.this$0._deviceConfigManager.getAvailabledHighestPriorityDevice(), null);
      return;
    } while (this.this$1.this$0.InternalConnectDevice(this.this$1.this$0.sessionConnectedDev, null) == 0);
    paramMessage = (String)((HashMap)localObject).get("PARAM_DEVICE");
    if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\sharp\jni\TraeAudioManager$TraeAudioManagerLooper$2.class
