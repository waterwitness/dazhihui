  ...
  extends Thread
{
  ...
  void startService(HashMap<String, Object> paramHashMap)
  {
    ...
    if (this._enabled)
    {
      ...
      if ((str != null) && (this.this$0._context != null)) {
        break label120;
      }
    }
    label120:
    while ((str.length() <= 0) || ((this._enabled) && (this._lastCfg.equals(str))) || (this.this$0._activeMode != 0))
    {
      return;
      paramHashMap = "N";
      break;
  ...
  void stopService()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        this.this$0.InternalSetMode(this._preServiceMode);
        _post_stopService();
        AudioDeviceInterface.LogTraceExit();
        return;
        if (this.this$0._activeMode != 2) {
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\sharp\jni\TraeAudioManager$TraeAudioManagerLooper.class
