  ...
  extends BroadcastReceiver
{
  ...
  public TraeAudioManager.BluetoohHeadsetCheckInterface CreateBluetoothCheck(Context paramContext, TraeAudioManager.DeviceConfigManager paramDeviceConfigManager)
  {
    ...
    for (paramContext = "Y";; paramContext = "N")
    {
      ...
      return (TraeAudioManager.BluetoohHeadsetCheckInterface)localObject2;
      if (Build.VERSION.SDK_INT != 18)
      {
  ...
  int InternalConnectDevice(String paramString, HashMap<String, Object> paramHashMap)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return -1;
          if ((!IsMusicScene) || ((!paramString.equals("DEVICE_EARPHONE")) && (!paramString.equals("DEVICE_BLUETOOTHHEADSET")))) {
            break;
          }
        } while (!QLog.isColorLevel());
        ...
        else
        {
          ...
          else if (!"android.media.AUDIO_BECOMING_NOISY".equals(paramIntent.getAction()))
          {
            if ("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_REQUEST".equals(str2))
            {
              ...
              {
                registerAudioSession(paramIntent.getBooleanExtra("REGISTERAUDIOSESSION_ISREGISTER", false), paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), paramContext);
                return;
              }
              if ("OPERATION_STARTSERVICE".equals(str1))
              {
                startService(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false, paramIntent.getStringExtra("EXTRA_DATA_DEVICECONFIG"));
                return;
              }
              if ("OPERATION_STOPSERVICE".equals(str1))
              {
                stopService(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
                return;
              }
              if ("OPERATION_GETDEVICELIST".equals(str1))
              {
                getDeviceList(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
                return;
              }
              if ("OPERATION_GETSTREAMTYPE".equals(str1))
              {
                getStreamType(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
                return;
              }
              if ("OPERATION_CONNECTDEVICE".equals(str1))
              {
                connectDevice(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false, paramIntent.getStringExtra("CONNECTDEVICE_DEVICENAME"));
                return;
              }
              if ("OPERATION_CONNECT_HIGHEST_PRIORITY_DEVICE".equals(str1))
              {
                connectHighestPriorityDevice(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
                return;
              }
              if ("OPERATION_EARACTION".equals(str1))
              {
                earAction(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false, paramIntent.getIntExtra("EXTRA_EARACTION", -1));
                return;
              }
              if ("OPERATION_ISDEVICECHANGABLED".equals(str1))
              {
                isDeviceChangabled(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
                return;
              }
              if ("OPERATION_GETCONNECTEDDEVICE".equals(str1))
              {
                getConnectedDevice(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
                return;
              }
              if ("OPERATION_GETCONNECTINGDEVICE".equals(str1))
              {
                getConnectingDevice(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
                return;
              }
              int i;
              int j;
              if ("OPERATION_VOICECALL_PREPROCESS".equals(str1))
              {
                ...
                voicecallPreprocess(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false, i, j);
                return;
              }
              if ("OPERATION_VOICECALL_POSTROCESS".equals(str1))
              {
                voicecallPostprocess(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
                return;
              }
              if ("OPERATION_VOICECALL_AUDIOPARAM_CHANGED".equals(str1))
              {
                i = paramIntent.getIntExtra("PARAM_MODEPOLICY", -1);
                j = paramIntent.getIntExtra("PARAM_STREAMTYPE", -1);
                voiceCallAudioParamChanged(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false, i, j);
                return;
              }
              if ("OPERATION_STARTRING".equals(str1))
              {
                ...
                startRing(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false, i, j, paramContext, str2, bool1, k, str3, bool2);
                return;
              }
              if ("OPERATION_STOPRING".equals(str1)) {
                stopRing(str1, paramIntent.getLongExtra("PARAM_SESSIONID", Long.MIN_VALUE), false);
              }
            }
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\sharp\jni\TraeAudioManager.class
