...
class TraeAudioManager$DeviceConfigManager
{
  ...
  public String getAvailabledHighestPriorityDevice()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localDeviceConfig != null) && (localDeviceConfig.getVisible()))
      {
        ...
        for (;;)
        {
          ...
          break;
          localObject2 = localDeviceConfig;
          if (localDeviceConfig.getPriority() < ((TraeAudioManager.DeviceConfigManager.DeviceConfig)localObject1).getPriority()) {
    ...
    this.mLock.unlock();
    if (localObject1 != null) {
      return ((TraeAudioManager.DeviceConfigManager.DeviceConfig)localObject1).getDeviceName();
    }
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\sharp\jni\TraeAudioManager$DeviceConfigManager.class
