...
public class OpenConfig
{
  ...
  private String a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 44	com/tencent/open/utils/OpenConfig:d	Ljava/lang/String;
    //   4: ifnull +107 -> 111
    ...
    //   23: aload_0
    //   24: getfield 44	com/tencent/open/utils/OpenConfig:d	Ljava/lang/String;
    ...
    //   33: astore_2
    //   34: aload_0
    //   35: getfield 42	com/tencent/open/utils/OpenConfig:c	Landroid/content/Context;
    //   38: aload_2
    //   39: invokevirtual 86	android/content/Context:openFileInput	(Ljava/lang/String;)Ljava/io/FileInputStream;
    //   42: astore_2
    //   43: aload_2
    //   44: astore_1
    //   45: new 88	java/io/BufferedReader
    //   48: dup
    //   49: new 90	java/io/InputStreamReader
    //   52: dup
    //   53: aload_1
    //   54: ldc 92
    //   56: invokestatic 98	java/nio/charset/Charset:forName	(Ljava/lang/String;)Ljava/nio/charset/Charset;
    //   59: invokespecial 101	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    //   62: invokespecial 104	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   65: astore_2
    ...
    //   73: astore_3
    //   74: aload_2
    //   75: invokevirtual 110	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   78: astore 4
    //   80: aload 4
    //   82: ifnull +58 -> 140
    //   85: aload_3
    //   86: aload 4
    //   88: invokevirtual 113	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   91: pop
    //   92: goto -18 -> 74
    //   95: astore_3
    //   96: aload_3
    //   97: invokevirtual 116	java/io/IOException:printStackTrace	()V
    //   100: aload_1
    //   101: invokevirtual 121	java/io/InputStream:close	()V
    //   104: aload_2
    ...
    //   116: astore_2
    //   117: aload_0
    //   118: getfield 42	com/tencent/open/utils/OpenConfig:c	Landroid/content/Context;
    //   121: invokevirtual 128	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   124: aload_1
    //   125: invokevirtual 134	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   128: astore_1
    //   129: goto -84 -> 45
    //   132: astore_1
    //   133: aload_1
    ...
    //   139: areturn
    //   140: aload_3
    //   141: invokevirtual 135	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   144: astore_3
    //   145: aload_1
    //   146: invokevirtual 121	java/io/InputStream:close	()V
    //   149: aload_2
    ...
    //   155: astore_1
    //   156: aload_1
    //   157: invokevirtual 116	java/io/IOException:printStackTrace	()V
    //   160: aload_3
    //   161: areturn
    //   162: astore_1
    //   163: aload_1
    //   164: invokevirtual 116	java/io/IOException:printStackTrace	()V
    //   167: ldc 124
    //   169: areturn
    //   170: astore_3
    //   171: aload_1
    ...
    //   175: aload_2
    //   176: invokevirtual 122	java/io/BufferedReader:close	()V
    //   179: aload_3
    //   180: athrow
    //   181: astore_1
    //   182: aload_1
    //   183: invokevirtual 116	java/io/IOException:printStackTrace	()V
    //   186: goto -7 -> 179
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\open\utils\OpenConfig.class
