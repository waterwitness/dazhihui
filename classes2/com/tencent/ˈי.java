  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        QLog.d("TIMSoundElem", 1, "downloading from url: " + (String)localObject3);
        localObject3 = (HttpURLConnection)new URL((String)localObject3).openConnection();
        QLog.d("TIMSoundElem", 1, "http resp code: " + ((HttpURLConnection)localObject3).getResponseCode() + "|descr: " + ((HttpURLConnection)localObject3).getResponseMessage());
        if (((HttpURLConnection)localObject3).getResponseCode() != 200)
        {
          ...
          this.a.b.post(new ˈـ(this, (String)localObject1));
          return;
        }
      }
      catch (Exception localException1)
      {
        ...
        this.a.b.post(new ˈٴ(this, localException1));
        return;
      }
      try
      {
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\com\tencent\ˈי.class
