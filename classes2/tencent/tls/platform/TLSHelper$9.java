...
{
  TLSHelper$9(TLSHelper paramTLSHelper, req_global paramreq_global, TLSSmsLoginListener paramTLSSmsLoginListener) {}
  ...
  public void done(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      this.val$listener.OnSmsLoginAskCodeSuccess(localasync_context._smslogin_reask, localasync_context._smslogin_expire);
      return;
    }
    if (paramInt == 64536)
    {
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\tencent\tls\platform\TLSHelper$9.class
