...
public class MultipartEntityBuilder
{
  ...
  MultipartFormEntity buildEntity()
  {
    ...
    if (this.subType != null)
    {
      ...
      localObject2 = new ArrayList(this.bodyParts);
      if (this.mode == null) {
        break label146;
      }
      localHttpMultipartMode = this.mode;
      label62:
      switch (MultipartEntityBuilder.1.$SwitchMap$org$apache$http$entity$mime$HttpMultipartMode[localHttpMultipartMode.ordinal()])
      {
      default: 
...
/* Location:              E:\apk\dazhihui2\classes2-dex2jar.jar!\org\apache\http\entity\mime\MultipartEntityBuilder.class
