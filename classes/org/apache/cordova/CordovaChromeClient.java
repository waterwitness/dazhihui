  ...
  extends WebChromeClient
{
  ...
  public boolean onConsoleMessage(ConsoleMessage paramConsoleMessage)
  {
    if (paramConsoleMessage.message() != null) {
      LOG.d(this.TAG, "%s: Line %d : %s", new Object[] { paramConsoleMessage.sourceId(), Integer.valueOf(paramConsoleMessage.lineNumber()), paramConsoleMessage.message() });
    }
  ...
  {
    LOG.d(this.TAG, "onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d", new Object[] { Long.valueOf(paramLong2), Long.valueOf(paramLong1), Long.valueOf(paramLong3) });
  ...
  public boolean onJsAlert(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
  {
    ...
    paramWebView.setPositiveButton(17039370, new CordovaChromeClient.1(this, paramJsResult));
    paramWebView.setOnCancelListener(new CordovaChromeClient.2(this, paramJsResult));
    paramWebView.setOnKeyListener(new CordovaChromeClient.3(this, paramJsResult));
    paramWebView.show();
    return true;
  }
  ...
  public boolean onJsConfirm(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
  {
    ...
    paramWebView.setCancelable(true);
    paramWebView.setPositiveButton(17039370, new CordovaChromeClient.4(this, paramJsResult));
    paramWebView.setNegativeButton(17039360, new CordovaChromeClient.5(this, paramJsResult));
    paramWebView.setOnCancelListener(new CordovaChromeClient.6(this, paramJsResult));
    paramWebView.setOnKeyListener(new CordovaChromeClient.7(this, paramJsResult));
    paramWebView.show();
    return true;
  }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramString1 = this.appView.exposedJsApi.exec(paramWebView, paramString1, paramString3, paramString2);
        ...
        {
          paramString1 = this.appView.exposedJsApi.retrieveJsMessages("1".equals(paramString2));
          paramWebView = paramString1;
          if (paramString1 == null) {
            paramWebView = "";
          }
        ...
        else
        {
          ...
          paramWebView.setPositiveButton(17039370, new CordovaChromeClient.8(this, paramString1, paramJsPromptResult));
          paramWebView.setNegativeButton(17039360, new CordovaChromeClient.9(this, paramJsPromptResult));
          paramWebView.show();
        }
      }
    }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\org\apache\cordova\CordovaChromeClient.class
