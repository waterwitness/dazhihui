...
public class ConfigService
{
  public static ConfigEntity LoadConfig(Context paramContext)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localConfigEntity.ip = "192.168.1.19";
      localConfigEntity.port = 8906;
      localConfigEntity.configMode = paramContext.getInt("configMode", 1);
      localConfigEntity.resolution_width = 320;
      localConfigEntity.resolution_height = 240;
      localConfigEntity.videoBitrate = paramContext.getInt("videoBitrate", 150000);
      localConfigEntity.videoFps = paramContext.getInt("videoFps", 15);
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\bairuitech\demo\ConfigService.class
