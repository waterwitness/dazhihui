  ...
  extends a
{
  ...
  public b(int paramInt, byte[] paramArrayOfByte)
  {
    ...
    if ((paramInt & 0x8) == 0) {}
    for (paramArrayOfByte = bG;; paramArrayOfByte = bH)
    {
      this.bI = paramArrayOfByte;
      this.state = 0;
      this.value = 0;
      return;
    }
  ...
  public final boolean a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    int i = this.value;
    int j = 0;
    byte[] arrayOfByte = this.bE;
    int[] arrayOfInt = this.bI;
    int m;
    if (paramInt1 >= i1)
    {
      m = i;
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\payeco\android\plugin\http\encryption\b.class
