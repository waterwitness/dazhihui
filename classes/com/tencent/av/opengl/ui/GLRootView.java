  ...
  implements GLSurfaceView.Renderer
{
    ...
    for (;;)
    {
      ...
      if (l - this.mFrameCountingStart > 1000000000L)
      {
        if (QLog.isColorLevel()) {
          QLog.d("GLRootView", 0, "fps: " + this.mFrameCount * 1.0E9D / (l - this.mFrameCountingStart));
        }
        this.mFrameCountingStart = l;
        this.mFrameCount = 0;
      }
  ...
  public void onSurfaceCreated(GL10 paramGL10, javax.microedition.khronos.egl.EGLConfig paramEGLConfig)
  {
    // Byte code:
    //   0: aload_1
    //   1: checkcast 295	javax/microedition/khronos/opengles/GL11
    //   4: astore_1
    //   5: aload_0
    //   6: getfield 297	com/tencent/av/opengl/ui/GLRootView:mGL	Ljavax/microedition/khronos/opengles/GL11;
    //   9: ifnull +48 -> 57
    //   12: invokestatic 153	com/tencent/av/utils/QLog:isColorLevel	()Z
    //   15: ifeq +42 -> 57
    //   18: ldc 19
    //   20: iconst_0
    ...
    //   34: aload_0
    //   35: getfield 297	com/tencent/av/opengl/ui/GLRootView:mGL	Ljavax/microedition/khronos/opengles/GL11;
    //   38: invokevirtual 302	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   41: ldc_w 304
    //   44: invokevirtual 162	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   47: aload_1
    //   48: invokevirtual 302	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   51: invokevirtual 171	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   54: invokestatic 175	com/tencent/av/utils/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   57: aload_0
    //   58: getfield 62	com/tencent/av/opengl/ui/GLRootView:mRenderLock	Ljava/util/concurrent/locks/ReentrantLock;
    //   61: invokevirtual 191	java/util/concurrent/locks/ReentrantLock:lock	()V
    //   64: aload_0
    //   65: aload_1
    //   66: putfield 297	com/tencent/av/opengl/ui/GLRootView:mGL	Ljavax/microedition/khronos/opengles/GL11;
    //   69: aload_0
    //   70: invokevirtual 308	com/tencent/av/opengl/ui/GLRootView:getContext	()Landroid/content/Context;
    //   73: invokevirtual 313	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   76: invokestatic 95	com/tencent/av/opengl/utils/Utils:getGLVersion	(Landroid/content/Context;)I
    //   79: iconst_2
    //   80: if_icmplt +32 -> 112
    //   83: new 315	com/tencent/av/opengl/glrenderer/GLES20Canvas
    //   86: dup
    //   87: invokespecial 316	com/tencent/av/opengl/glrenderer/GLES20Canvas:<init>	()V
    //   90: astore_1
    //   91: aload_0
    //   92: aload_1
    //   93: putfield 234	com/tencent/av/opengl/ui/GLRootView:mCanvas	Lcom/tencent/av/opengl/glrenderer/GLCanvas;
    //   96: invokestatic 321	com/tencent/av/opengl/texture/BasicTexture:invalidateAllTextures	()V
    //   99: aload_0
    //   100: getfield 62	com/tencent/av/opengl/ui/GLRootView:mRenderLock	Ljava/util/concurrent/locks/ReentrantLock;
    //   103: invokevirtual 196	java/util/concurrent/locks/ReentrantLock:unlock	()V
    //   106: aload_0
    //   107: iconst_0
    //   108: invokevirtual 324	com/tencent/av/opengl/ui/GLRootView:setRenderMode	(I)V
    //   111: return
    //   112: new 326	com/tencent/av/opengl/glrenderer/GLES11Canvas
    //   115: dup
    //   116: aload_1
    //   117: invokespecial 329	com/tencent/av/opengl/glrenderer/GLES11Canvas:<init>	(Ljavax/microedition/khronos/opengles/GL11;)V
    //   120: astore_1
    //   121: goto -30 -> 91
    //   124: astore_1
    //   125: aload_0
    //   126: getfield 62	com/tencent/av/opengl/ui/GLRootView:mRenderLock	Ljava/util/concurrent/locks/ReentrantLock;
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\tencent\av\opengl\ui\GLRootView.class
