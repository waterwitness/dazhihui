...
public class MemberListAdapterHost
  extends BaseAdapter
{
  ...
  public MemberListAdapterHost(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = new MemberListAdapterHost.ViewHolder();
      ...
      try
      {
        ...
        if (paramInt > 0)
        {
          ...
          if (paramInt <= 99)
          {
            ...
            return localView;
            paramViewGroup = (MemberListAdapterHost.ViewHolder)paramView.getTag();
            localView = paramView;
            break;
            label418:
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\tencent\avsdkhost\MemberListAdapterHost.class
