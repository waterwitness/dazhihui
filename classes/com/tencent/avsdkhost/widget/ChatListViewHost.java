  ...
  extends ListView
{
  ...
  public ChatListViewHost(Context paramContext)
  {
    super(paramContext);
    init(paramContext);
  }
  
  public ChatListViewHost(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    init(paramContext);
  }
  
  public ChatListViewHost(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  {
    this.mChatMsgListAdapter = new ChatMsgGuestListAdapterHost(this.mContext, paramMessageControlHost.getListChatEntity());
    ...
    setOnScrollListener(new ChatListViewHost.1(this));
  }
  ...
  public void setUnreadView(View paramView)
  {
    if (paramView != null)
    {
      ...
      this.mUnreadChatView.setOnClickListener(new ChatListViewHost.2(this));
    }
  }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\tencent\avsdkhost\widget\ChatListViewHost.class
