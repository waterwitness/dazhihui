  ...
  private void b(Activity paramActivity, Bundle paramBundle, IUiListener paramIUiListener)
  {
    ...
    if (SystemUtils.compareQQVersion(paramActivity, "4.6.0") < 0)
    {
      ...
      if (hasActivityForIntent(paramBundle))
      {
        ...
        startAssitActivity(paramActivity, paramBundle, 11103);
      }
      if (!hasActivityForIntent(paramBundle)) {
        break label956;
      }
    ...
    for (;;)
    {
      ...
      startAssistActivity(paramActivity, 10103, paramBundle, true);
      break;
      label956:
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\tencent\connect\share\QQShare.class
