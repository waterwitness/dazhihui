...
public final class d
{
  ...
  private static String d()
  {
    ...
    //   41: iconst_3
    //   42: ldc 51
    //   44: invokestatic 57	com/tencent/beacon/b/a:b	([BILjava/lang/String;)[B
    //   47: astore_1
    //   48: aload_1
    //   49: ifnull +18 -> 67
  ...
  public final String a()
  {
    ...
    b.b("Load QIMEI from share preference, QIMEI is %s.", new Object[] { localObject2 });
    Object localObject1;
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        localObject2 = d();
        b.b("Load QIMEI from SDCard, QIMEI is %s.", new Object[] { localObject2 });
        localObject1 = localObject2;
        if (localObject2 != null)
        {
          localObject1 = localObject2;
          if (!((String)localObject2).trim().equals(""))
          {
            b.b("Save QIMEI to shared prefs: %s.", new Object[] { localObject2 });
      ...
      b.b("Return QIMEI %s.", new Object[] { localObject2 });
  ...
  public final void a(String paramString)
  {
    ...
    //   16: return
    //   17: aload_0
    //   18: getfield 13	com/tencent/beacon/e/d:a	Landroid/content/Context;
    //   21: invokestatic 90	com/tencent/beacon/a/h:a	(Landroid/content/Context;)Lcom/tencent/beacon/a/h;
    //   24: pop
    //   25: invokestatic 93	android/os/Environment:getExternalStorageState	()Ljava/lang/String;
    //   28: ldc 95
    ...
    //   58: astore_3
    //   59: aload_2
    //   60: invokevirtual 110	java/io/File:getParentFile	()Ljava/io/File;
    //   63: invokevirtual 114	java/io/File:mkdirs	()Z
    //   66: pop
    //   67: aload_2
    //   68: invokevirtual 117	java/io/File:createNewFile	()Z
    //   71: pop
    //   72: new 119	java/io/FileOutputStream
    //   75: dup
    //   76: aload_2
    //   77: invokespecial 120	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   80: astore_2
    //   81: aload_2
    //   82: aload_1
    //   83: invokevirtual 124	java/lang/String:getBytes	()[B
    //   86: iconst_3
    //   87: ldc 51
    //   89: invokestatic 126	com/tencent/beacon/b/a:a	([BILjava/lang/String;)[B
    //   92: invokevirtual 129	java/io/FileOutputStream:write	([B)V
    //   95: aload_2
    //   96: invokevirtual 132	java/io/FileOutputStream:flush	()V
    //   99: aload_2
    //   100: invokevirtual 133	java/io/FileOutputStream:close	()V
    //   103: ldc -121
    //   105: iconst_1
    ...
    //   111: aload_1
    //   112: aastore
    //   113: invokestatic 78	com/tencent/beacon/e/b:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   116: aload_0
    //   117: getfield 13	com/tencent/beacon/e/d:a	Landroid/content/Context;
    //   120: ldc 64
    //   122: aload_1
    //   123: invokestatic 104	com/tencent/beacon/a/b:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    //   126: pop
    //   127: ldc -119
    //   129: iconst_1
    ...
    //   135: aload_1
    //   136: aastore
    //   137: invokestatic 78	com/tencent/beacon/e/b:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   140: return
    //   141: iconst_0
    //   142: istore 4
    //   144: goto -105 -> 39
    ...
    //   169: ifnull -66 -> 103
    //   172: aload_2
    //   173: invokevirtual 133	java/io/FileOutputStream:close	()V
    //   176: goto -73 -> 103
    //   179: astore_2
    //   180: goto -77 -> 103
    //   183: astore_1
    ...
    //   187: ifnull +7 -> 194
    //   190: aload_2
    //   191: invokevirtual 133	java/io/FileOutputStream:close	()V
    //   194: aload_1
    //   195: athrow
    //   196: astore_2
    //   197: goto -94 -> 103
  ...
  public final boolean b()
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (a.t().equals(com.tencent.beacon.a.b.b(this.a, "GEN_QIMEI", "")))
    {
      bool1 = bool2;
      if (com.tencent.beacon.a.b.b(this.a, "GEN_QIMEI_TIMES", 0) >= e.a().g()) {
        bool1 = true;
      }
    }
    return bool1;
  ...
  {
    int i = 0;
    int j = com.tencent.beacon.a.b.b(this.a, "GEN_QIMEI_TIMES", 0);
    if (!a.t().equals(com.tencent.beacon.a.b.b(this.a, "GEN_QIMEI", ""))) {
      com.tencent.beacon.a.b.a(this.a, "GEN_QIMEI", a.t());
    }
    for (;;)
    {
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\tencent\beacon\e\d.class
