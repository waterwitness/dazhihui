  ...
  extends SQLiteOpenHelper
{
  ...
  {
    super(paramContext, "beacon_db", null, 18);
    this.a = paramContext;
  }
  ...
  private boolean a(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   70: astore_2
    //   71: aload_1
    //   72: invokevirtual 65	java/lang/Throwable:printStackTrace	()V
    //   75: aload_3
    //   76: ifnull +18 -> 94
    //   79: aload_3
    ...
    //   146: checkcast 36	java/lang/String
    //   149: astore 5
    //   151: aload_3
    //   152: astore_2
    //   153: aload_1
    ...
    //   157: ldc 96
    //   159: iconst_1
    //   160: anewarray 98	java/lang/Object
    //   163: dup
    //   164: iconst_0
    //   165: aload 5
    //   167: aastore
    //   168: invokestatic 102	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   171: invokevirtual 106	android/database/sqlite/SQLiteDatabase:execSQL	(Ljava/lang/String;)V
    //   174: aload_3
    //   175: astore_2
    //   176: ldc 108
    //   178: iconst_1
    //   179: anewarray 98	java/lang/Object
    //   182: dup
    //   183: iconst_0
    //   184: aload 5
    //   186: aastore
    //   187: invokestatic 114	com/tencent/beacon/e/b:g	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   190: goto -65 -> 125
    //   193: astore_1
    //   194: aload_2
    //   195: ifnull +18 -> 213
    ...
    //   221: ifnull +18 -> 239
    //   224: aload_3
    //   225: invokeinterface 68 1 0
    //   230: ifne +9 -> 239
    //   233: aload_3
    //   234: invokeinterface 71 1 0
    //   239: iconst_1
    //   240: istore 6
    //   242: goto -145 -> 97
    //   245: astore_1
  ...
  public final SQLiteDatabase getReadableDatabase()
  {
    ...
    while ((localObject == null) && (i < 5))
    {
      ...
      {
        b.c("getReadableDatabase error count  %d", new Object[] { Integer.valueOf(i) });
        if (i == 5) {
          b.d("error get DB failed", new Object[0]);
        }
        try
        {
          Thread.sleep(200L);
  ...
  public final SQLiteDatabase getWritableDatabase()
  {
    ...
    while ((localObject == null) && (i < 5))
    {
      ...
      {
        b.c("getWritableDatabase error count %d", new Object[] { Integer.valueOf(i) });
        if (i == 5) {
          b.d("error get DB failed", new Object[0]);
        }
        try
    ...
    try
    {
      if (c.a != null)
      {
        ...
        while (i < j)
        {
          ...
          b.g("table:%s", new Object[] { arrayOfString1[0] });
  ...
  public final void onDowngrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 22	com/tencent/beacon/a/a/d:a	Landroid/content/Context;
    //   6: invokestatic 171	com/tencent/beacon/a/h:a	(Landroid/content/Context;)Lcom/tencent/beacon/a/h;
    //   9: pop
    //   10: invokestatic 174	com/tencent/beacon/a/h:d	()Ljava/lang/String;
    ...
    //   45: aastore
    //   46: invokestatic 114	com/tencent/beacon/e/b:g	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   49: aload_0
    //   50: aload_1
    //   51: invokespecial 182	com/tencent/beacon/a/a/d:a	(Landroid/database/sqlite/SQLiteDatabase;)Z
    //   54: ifeq +20 -> 74
    //   57: ldc -72
    //   59: iconst_0
    //   60: anewarray 98	java/lang/Object
    //   63: invokestatic 114	com/tencent/beacon/e/b:g	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   66: aload_0
    //   67: aload_1
    //   68: invokevirtual 186	com/tencent/beacon/a/a/d:onCreate	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   71: aload_0
    //   72: monitorexit
    //   73: return
    //   74: ldc -68
    ...
    //   80: invokestatic 136	com/tencent/beacon/e/b:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   83: aload_0
    //   84: getfield 22	com/tencent/beacon/a/a/d:a	Landroid/content/Context;
    //   87: ldc 17
  ...
  public final void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    ...
    //   26: aastore
    //   27: invokestatic 114	com/tencent/beacon/e/b:g	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   30: aload_0
    //   31: aload_1
    //   32: invokespecial 182	com/tencent/beacon/a/a/d:a	(Landroid/database/sqlite/SQLiteDatabase;)Z
    //   35: ifeq +20 -> 55
    //   38: ldc -72
    //   40: iconst_0
    //   41: anewarray 98	java/lang/Object
    //   44: invokestatic 114	com/tencent/beacon/e/b:g	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   47: aload_0
    //   48: aload_1
    //   49: invokevirtual 186	com/tencent/beacon/a/a/d:onCreate	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   52: aload_0
    //   53: monitorexit
    //   54: return
    //   55: ldc -68
    ...
    //   61: invokestatic 136	com/tencent/beacon/e/b:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   64: aload_0
    //   65: getfield 22	com/tencent/beacon/a/a/d:a	Landroid/content/Context;
    //   68: ldc 17
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\tencent\beacon\a\a\d.class
