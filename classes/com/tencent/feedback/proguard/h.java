...
public final class h
{
  ...
  private void a(byte paramByte)
  {
    ...
    case 13: 
      ...
      a(localb, this.a);
      if (localb.a != 0) {
        throw new g("skipField with invalid type, type value: " + paramByte + ", " + localb.a);
      }
  ...
  private boolean a(int paramInt)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        if ((paramInt <= localb.b) || (localb.a == 11))
        {
    ...
    if (a(paramInt))
    {
      ...
      case 13: 
        ...
        if (((b)localObject2).a != 0) {
          throw new g("type mismatch, tag: " + paramInt + ", type: " + ((b)localObject1).a + ", " + ((b)localObject2).a);
        }
        i = a(0, 0, true);
        if (i < 0) {
          throw new g("invalid size, tag: " + paramInt + ", type: " + ((b)localObject1).a + ", " + ((b)localObject2).a + ", size: " + i);
        }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\tencent\feedback\proguard\h.class
