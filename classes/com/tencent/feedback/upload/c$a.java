  ...
  extends c
{
  ...
  private HttpResponse a(String paramString1, byte[] paramArrayOfByte, String paramString2)
  {
    ...
    //   10: ldc 25
    //   12: iconst_0
    //   13: anewarray 27	java/lang/Object
    //   16: invokestatic 33	com/tencent/feedback/common/e:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   19: aload 4
    //   21: astore_1
    //   22: aload_1
    //   23: areturn
    //   24: aload_2
    //   25: ifnull +80 -> 105
    //   28: new 35	org/apache/http/entity/ByteArrayEntity
    //   31: dup
    //   32: aload_2
    //   33: invokespecial 38	org/apache/http/entity/ByteArrayEntity:<init>	([B)V
    //   36: astore_2
    //   37: aload_0
    //   38: aload_3
    //   39: invokespecial 41	com/tencent/feedback/upload/c$a:a	(Ljava/lang/String;)Lorg/apache/http/client/HttpClient;
    //   42: astore 4
    //   44: aload 4
    //   46: ifnonnull +90 -> 136
    //   49: ldc 43
    ...
    //   55: invokestatic 33	com/tencent/feedback/common/e:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   58: aconst_null
    //   59: areturn
    //   60: astore 4
    //   62: aconst_null
    ...
    //   68: astore_1
    //   69: aload 4
    //   71: invokevirtual 46	java/lang/Throwable:printStackTrace	()V
    //   74: aload_3
    //   75: astore_1
    //   76: ldc 48
    //   78: iconst_1
    //   79: anewarray 27	java/lang/Object
    //   82: dup
    //   83: iconst_0
    //   84: aload 4
    //   86: invokevirtual 52	java/lang/Throwable:toString	()Ljava/lang/String;
    //   89: aastore
    //   90: invokestatic 33	com/tencent/feedback/common/e:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   93: aload_2
    //   94: astore_1
    //   95: aload_3
    //   96: ifnull -74 -> 22
    //   99: aload_3
    //   100: invokevirtual 57	org/apache/http/client/methods/HttpPost:abort	()V
    //   103: aload_2
    //   104: areturn
    //   105: new 35	org/apache/http/entity/ByteArrayEntity
    //   108: dup
    //   109: ldc 59
    //   111: invokevirtual 65	java/lang/String:getBytes	()[B
    //   114: invokespecial 38	org/apache/http/entity/ByteArrayEntity:<init>	([B)V
    //   117: astore_2
    //   118: goto -81 -> 37
    //   121: astore_1
    //   122: aconst_null
    ...
    //   127: ifnull +7 -> 134
    //   130: aload_3
    //   131: invokevirtual 57	org/apache/http/client/methods/HttpPost:abort	()V
    //   134: aload_2
    //   135: athrow
    //   136: new 54	org/apache/http/client/methods/HttpPost
    //   139: dup
    //   140: aload_1
    //   141: invokespecial 68	org/apache/http/client/methods/HttpPost:<init>	(Ljava/lang/String;)V
    //   144: astore_3
    //   145: aload_3
    //   146: astore_1
    //   147: aload_3
    //   148: ldc 70
    //   150: ldc 72
    //   152: invokevirtual 76	org/apache/http/client/methods/HttpPost:setHeader	(Ljava/lang/String;Ljava/lang/String;)V
    //   155: aload_3
    //   156: astore_1
    //   157: aload_3
    //   158: aload_2
    //   159: invokevirtual 80	org/apache/http/client/methods/HttpPost:setEntity	(Lorg/apache/http/HttpEntity;)V
    //   162: aload_3
    //   163: astore_1
    //   164: new 82	org/apache/http/protocol/BasicHttpContext
    //   167: dup
    //   168: invokespecial 83	org/apache/http/protocol/BasicHttpContext:<init>	()V
    //   171: astore 6
    //   173: aload_3
    //   174: astore_1
    //   175: aload 4
    ...
    //   188: ldc 91
    //   190: iconst_1
    //   191: anewarray 27	java/lang/Object
    //   194: dup
    //   195: iconst_0
    //   196: aload 6
    //   198: ldc 93
    //   200: invokeinterface 99 2 0
    //   205: checkcast 101	org/apache/http/HttpRequest
    //   208: invokeinterface 105 1 0
    //   213: invokevirtual 106	java/lang/Object:toString	()Ljava/lang/String;
    //   216: aastore
    //   217: invokestatic 109	com/tencent/feedback/common/e:h	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   220: aload_3
    //   221: invokevirtual 57	org/apache/http/client/methods/HttpPost:abort	()V
    //   224: aload_2
    //   225: areturn
    //   226: astore_2
    //   227: aload_1
  ...
  private static byte[] a(HttpResponse paramHttpResponse)
  {
    ...
    //   25: ldc -46
    //   27: iconst_2
    //   28: anewarray 27	java/lang/Object
    //   31: dup
    //   32: iconst_0
    //   33: iload_3
    ...
    //   63: ldc -31
    //   65: iconst_0
    //   66: anewarray 27	java/lang/Object
    //   69: invokestatic 33	com/tencent/feedback/common/e:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   72: aconst_null
    //   73: areturn
    ...
    //   129: astore_0
    //   130: aload_2
    //   131: invokevirtual 46	java/lang/Throwable:printStackTrace	()V
    //   134: aload_1
    //   135: astore_0
    //   136: ldc -5
    //   138: iconst_1
    //   139: anewarray 27	java/lang/Object
    //   142: dup
    //   143: iconst_0
    //   144: aload_2
    //   145: invokevirtual 52	java/lang/Throwable:toString	()Ljava/lang/String;
    //   148: aastore
    //   149: invokestatic 33	com/tencent/feedback/common/e:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   152: aload_1
    //   153: ifnull -149 -> 4
    //   156: aload_1
    ...
    //   162: astore_0
    //   163: aload_0
    //   164: invokevirtual 46	java/lang/Throwable:printStackTrace	()V
    //   167: aconst_null
    //   168: areturn
    //   169: aload_1
    //   170: astore_0
    ...
    //   188: astore_0
    //   189: aload_0
    //   190: invokevirtual 46	java/lang/Throwable:printStackTrace	()V
    //   193: aload_2
    //   194: areturn
    //   195: astore_1
    //   196: aconst_null
    ...
    //   208: astore_0
    //   209: aload_0
    //   210: invokevirtual 46	java/lang/Throwable:printStackTrace	()V
    //   213: goto -7 -> 206
    //   216: astore_1
    //   217: goto -19 -> 198
    //   220: astore_2
    ...
    //   94	89	1	localBufferedInputStream	java.io.BufferedInputStream
    //   195	12	1	localObject1	Object
    //   216	1	1	localObject2	Object
    //   222	1	1	localObject3	Object
    //   104	16	2	localByteArrayOutputStream	java.io.ByteArrayOutputStream
    //   127	51	2	localThrowable1	Throwable
    //   181	13	2	arrayOfByte	byte[]
    //   220	1	2	localThrowable2	Throwable
    //   17	104	3	i	int
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\tencent\feedback\upload\c$a.class
