...
class x
{
  ...
  {
    y localy2 = new y(paramInt1, paramByte);
    y localy1 = this.d;
    if (paramByte <= 8)
    {
    ...
    for (;;)
    {
      if (paramInt1 >= paramInt2 + (1 << paramByte))
      {
        ...
        if (y.a(localy1)[paramInt1] == null) {
          y.a(localy1)[paramInt1] = new y();
        }
        localy1 = y.a(localy1)[paramInt1];
        break;
      }
      y.a(localy1)[paramInt1] = localy2;
      paramInt1 += 1;
    }
  }
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          localy = y.a(localy)[(k >>> i - 8 & 0xFF)];
          if (y.a(localy) == null)
          {
            localByteArrayOutputStream.write(y.b(localy));
            i -= y.c(localy);
            localy = this.d;
          }
          else
        ...
        paramArrayOfByte = y.a(localy)[(k << 8 - i & 0xFF)];
      } while ((y.a(paramArrayOfByte) != null) || (y.c(paramArrayOfByte) > i));
      localByteArrayOutputStream.write(y.b(paramArrayOfByte));
      i -= y.c(paramArrayOfByte);
      localy = this.d;
    }
  }
}
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\d\a\c\d\x.class
