  ...
  implements Closeable
{
  ...
  public DiskLruCache.Snapshot get(String paramString)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: invokespecial 298	com/squareup/okhttp/internal/DiskLruCache:checkNotClosed	()V
    //   8: aload_0
    //   9: aload_1
    //   10: invokespecial 301	com/squareup/okhttp/internal/DiskLruCache:validateKey	(Ljava/lang/String;)V
    //   13: aload_0
    //   14: getfield 92	com/squareup/okhttp/internal/DiskLruCache:lruEntries	Ljava/util/LinkedHashMap;
    //   17: aload_1
    //   18: invokevirtual 304	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   21: checkcast 198	com/squareup/okhttp/internal/DiskLruCache$Entry
    //   24: astore 5
    //   26: aload 5
    //   28: ifnonnull +9 -> 37
    //   31: aload_3
    ...
    //   38: astore_2
    //   39: aload 5
    //   41: invokestatic 205	com/squareup/okhttp/internal/DiskLruCache$Entry:access$0	(Lcom/squareup/okhttp/internal/DiskLruCache$Entry;)Z
    //   44: ifeq -11 -> 33
    //   47: aload_0
    //   48: getfield 136	com/squareup/okhttp/internal/DiskLruCache:valueCount	I
    //   51: anewarray 539	java/io/InputStream
    //   54: astore 4
    //   56: iconst_0
    //   57: istore 6
    //   59: aload_0
    //   60: getfield 136	com/squareup/okhttp/internal/DiskLruCache:valueCount	I
    //   63: istore 7
    //   65: iload 6
    //   67: iload 7
    //   69: if_icmplt +93 -> 162
    //   72: aload_0
    //   73: aload_0
    //   74: getfield 166	com/squareup/okhttp/internal/DiskLruCache:redundantOpCount	I
    //   77: iconst_1
    //   78: iadd
    //   79: putfield 166	com/squareup/okhttp/internal/DiskLruCache:redundantOpCount	I
    //   82: aload_0
    //   83: getfield 142	com/squareup/okhttp/internal/DiskLruCache:journalWriter	Ljava/io/Writer;
    //   86: new 213	java/lang/StringBuilder
    //   89: dup
    //   90: ldc_w 541
    //   93: invokespecial 216	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   96: aload_1
    //   97: invokevirtual 223	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   100: bipush 10
    //   102: invokevirtual 230	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   105: invokevirtual 233	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   108: invokevirtual 544	java/io/Writer:append	(Ljava/lang/CharSequence;)Ljava/io/Writer;
    //   111: pop
    //   112: aload_0
    //   113: invokespecial 158	com/squareup/okhttp/internal/DiskLruCache:journalRebuildRequired	()Z
    //   116: ifeq +15 -> 131
    //   119: aload_0
    //   120: getfield 112	com/squareup/okhttp/internal/DiskLruCache:executorService	Ljava/util/concurrent/ThreadPoolExecutor;
    //   123: aload_0
    //   124: getfield 119	com/squareup/okhttp/internal/DiskLruCache:cleanupCallable	Ljava/util/concurrent/Callable;
    //   127: invokevirtual 248	java/util/concurrent/ThreadPoolExecutor:submit	(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
    //   130: pop
    //   131: new 546	com/squareup/okhttp/internal/DiskLruCache$Snapshot
    //   134: dup
    //   135: aload_0
    //   136: aload_1
    //   137: aload 5
    //   139: invokestatic 307	com/squareup/okhttp/internal/DiskLruCache$Entry:access$8	(Lcom/squareup/okhttp/internal/DiskLruCache$Entry;)J
    //   142: aload 4
    //   144: aload 5
    //   146: invokestatic 276	com/squareup/okhttp/internal/DiskLruCache$Entry:access$7	(Lcom/squareup/okhttp/internal/DiskLruCache$Entry;)[J
    //   149: aconst_null
    //   150: invokespecial 549	com/squareup/okhttp/internal/DiskLruCache$Snapshot:<init>	(Lcom/squareup/okhttp/internal/DiskLruCache;Ljava/lang/String;J[Ljava/io/InputStream;[JLcom/squareup/okhttp/internal/DiskLruCache$Snapshot;)V
    //   153: astore_2
    //   154: goto -121 -> 33
    //   157: astore_1
    //   158: aload_0
    ...
    //   162: aload 4
    //   164: iload 6
    //   166: new 427	java/io/FileInputStream
    //   169: dup
    //   170: aload 5
    //   172: iload 6
    //   174: invokevirtual 269	com/squareup/okhttp/internal/DiskLruCache$Entry:getCleanFile	(I)Ljava/io/File;
    //   177: invokespecial 429	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   180: aastore
    //   181: iload 6
    //   183: iconst_1
    //   184: iadd
    ...
    //   196: iload 6
    //   198: aload_0
    //   199: getfield 136	com/squareup/okhttp/internal/DiskLruCache:valueCount	I
    ...
    //   217: iload 6
    //   219: aaload
    //   220: invokestatic 457	com/squareup/okhttp/internal/Util:closeQuietly	(Ljava/io/Closeable;)V
    //   223: iload 6
    //   225: iconst_1
    //   226: iadd
    //   227: istore 6
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\squareup\okhttp\internal\DiskLruCache.class
