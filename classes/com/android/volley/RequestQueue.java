...
public class RequestQueue
{
  ...
  private List<RequestQueue.RequestFinishedListener> mFinishedListeners = new ArrayList();
  ...
  <T> void finish(Request<T> paramRequest)
  {
    for (;;)
    {
      ...
      synchronized (this.mWaitingRequests)
      {
        ...
        throw paramRequest;
        ((RequestQueue.RequestFinishedListener)((Iterator)localObject2).next()).onRequestFinished(paramRequest);
        continue;
        paramRequest = finally;
        throw paramRequest;
      }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\volley\RequestQueue.class
