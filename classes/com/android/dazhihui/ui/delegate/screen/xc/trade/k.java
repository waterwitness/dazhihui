  ...
  extends BaseAdapter
{
  ...
  public k(a parama, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        paramViewGroup.b.setOnClickListener(new l(this));
        return localView;
        ...
        if (paramInt == 1)
        {
          paramView = a.g(this.a);
          break label127;
        }
        if (paramInt != 2) {
          break label314;
        }
        paramView = a.h(this.a);
        break label127;
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\delegate\screen\xc\trade\k.class
