  ...
  extends View
{
  ...
  public KlineDetailView(Context paramContext)
  {
    super(paramContext);
    b();
  }
  
  public KlineDetailView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    b();
  }
  
  public KlineDetailView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  public void a()
  {
    ...
    if (localStockVo != null)
    {
      ...
      long[][] arrayOfLong1 = this.i.getAvgPrice();
      int i2 = this.i.getScreenIndex();
