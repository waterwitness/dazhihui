...
public class KlineMoveLineView
  extends View
{
  protected Paint a;
  private int b;
  ...
  public KlineMoveLineView(Context paramContext)
  {
    super(paramContext);
    a();
  }
  
  public KlineMoveLineView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    a();
  }
  
  public KlineMoveLineView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((j != -1) && (localObject != null) && (arrayOfInt != null))
    {
      ...
      paramCanvas.drawLine(f1, i3, f1, i3 + this.e.getParamsViewHeight(), this.a);
      j += i;
      i = j;
