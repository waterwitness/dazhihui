  ...
  implements Serializable
{
  ...
  public MarketStockVo(String paramString)
  {
    this.name = "";
  ...
  public MarketStockVo(String paramString1, String paramString2, int paramInt)
  {
  ...
  public MarketStockVo(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public MarketStockVo(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    this.name = paramString1;
    this.code = paramString2;
    this.type = paramInt1;
  ...
  public MarketStockVo(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean2)
  {
    this.name = paramString1;
    this.code = paramString2;
    this.type = paramInt1;
  ...
  public String getCjl()
  {
    ...
    return n.a(b.b(this.cjl));
  }
  
  public int getCjlColor(y paramy)
  {
    if (paramy == y.b) {
      return -16777216;
    }
  ...
  public void setCjl(int paramInt)
  {
    this.cjl = paramInt;
  }
  
  public void setCjl_dw(int paramInt)
  {
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\model\stock\market\MarketStockVo.class
