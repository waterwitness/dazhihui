...
public class Stock2991Vo
{
  ...
  public void decode(q paramq)
  {
    ...
    this.csgg = paramq.h();
    this.zszf = paramq.d();
    this.mjssjz = paramq.h();
    this.mjzrjz = paramq.h();
    this.szmjxz = paramq.h();
    this.xzmjxd = paramq.h();
    this.hs = paramq.h();
    this.lb = paramq.h();
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\model\stock\Stock2991Vo.class
