...
public class Stock2955Vo
{
  ...
  public void decode(q paramq, int paramInt1, int paramInt2)
  {
    boolean bool = true;
    try
    {
  ...
  public void getData(String[] paramArrayOfString1, String[] paramArrayOfString2, int[] paramArrayOfInt, int paramInt)
  {
    ...
    if (k < paramArrayOfString1.length)
    {
      ...
      for (;;)
      {
        ...
        continue;
        if (paramArrayOfString1[k].equals("最新"))
        {
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\model\stock\Stock2955Vo.class
