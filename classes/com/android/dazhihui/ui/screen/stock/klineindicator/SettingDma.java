  ...
  implements View.OnClickListener, SeekBar.OnSeekBarChangeListener
{
  ...
  public void init(Bundle paramBundle)
  {
    ...
    this.i.addTextChangedListener(new h(this, this.i, 2, 500, 1));
    this.j.addTextChangedListener(new h(this, this.j, 10, 500, 2));
    this.k.addTextChangedListener(new h(this, this.k, 1, 500, 3));
  ...
  public void onProgressChanged(SeekBar paramSeekBar, int paramInt, boolean paramBoolean)
  {
    ...
    case 2131560404: 
      ...
      return;
    case 2131560407: 
      this.b[1] = (paramInt + 10);
      this.j.setText(paramInt + 10 + "");
      this.j.setSelection(this.j.getText().length());
      return;
    }
    this.b[2] = (paramInt + 1);
    this.k.setText(paramInt + 1 + "");
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\screen\stock\klineindicator\SettingDma.class
