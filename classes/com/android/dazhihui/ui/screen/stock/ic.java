  ...
  implements eg
{
  ...
  public ic(hw paramhw, ad paramad)
  {
    super(paramad);
    this.b = paramad;
  }
  ...
  {
    if ((hw.c(this.a) != null) && (paramInt == hw.c(this.a).length - 1)) {}
    return 0;
  }
  
  public void a()
  {
    if ((hw.c(this.a) != null) && (this.b != null))
    {
      at localat = this.b.a();
      int i = 0;
      while (i < hw.c(this.a).length)
      {
        if (hw.c(this.a)[i] != null)
        {
          if ((hw.c(this.a)[i] instanceof sk)) {}
          localat.a(hw.c(this.a)[i]);
        }
        i += 1;
      }
      localat.b();
  ...
  public int getCount()
  {
    ...
    return hw.c(this.a).length;
  }
  
  public Fragment getItem(int paramInt)
  {
    return hw.c(this.a)[paramInt];
  }
  ...
  {
    if ((hw.f(this.a) == null) || (hw.f(this.a).length == 0) || (paramInt < 0) || (paramInt >= hw.f(this.a).length)) {
      return "";
    }
    return hw.f(this.a)[paramInt];
  }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\screen\stock\ic.class
