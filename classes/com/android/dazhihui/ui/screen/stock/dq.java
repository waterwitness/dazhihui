    ...
    do
    {
      ...
      if ((paramh != null) && (paramh.a == 2314))
      {
        ...
        while (i < j)
        {
          ...
          arrayOfInt[3] = -1;
          arrayOfString[4] = b.j(i1, i1 + i2);
          arrayOfInt[4] = -1;
          arrayOfString[5] = String.valueOf(i2);
          arrayOfInt[5] = -1;
          arrayOfString[6] = b.j(i2, i1 + i2);
          arrayOfInt[6] = -1;
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\screen\stock\dq.class
