  ...
  extends View
{
  ...
  public r(p paramp, Context paramContext)
  {
    super(paramContext);
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    paramCanvas.save();
    if ((p.a(this.a) != null) && (p.a(this.a).length > 0))
    {
      int k = this.c;
      ...
      String[][] arrayOfString = p.a(this.a);
      ...
      j = this.d.width() + p.b(this.a) / 2 * (p.a(this.a).length - 1);
      i = k;
      while (j >= getWidth())
      {
        i -= 1;
      ...
      i = 0;
      j = n + 3;
      while (i < p.a(this.a).length)
      {
        localObject = p.a(this.a)[i][0] + p.a(this.a)[i][1];
        this.b.setColor(p.c(this.a)[i]);
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\widget\stockchart\r.class
