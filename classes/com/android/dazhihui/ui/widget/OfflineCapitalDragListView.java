...
import com.android.dazhihui.ui.screen.stock.offlinecapital.ab;
import com.android.dazhihui.ui.screen.stock.offlinecapital.ag;

public class OfflineCapitalDragListView
  extends NoScrollListView
{
  ...
  private Context l;
  private int m = 0;
  private ag n = new ag("", "", 0);
  
  public OfflineCapitalDragListView(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  {
    ag localag = this.k.a(paramInt2);
    this.k.a(this.k.a(paramInt1));
    this.k.a(localag);
    this.k.a(localag, paramInt1);
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      paramMotionEvent = this.j.findViewById(2131558845);
  ...
  public void setAdapter(ListAdapter paramListAdapter)
  {
    ...
    this.k = ((ab)getAdapter());
  }
}


/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\widget\OfflineCapitalDragListView.class
