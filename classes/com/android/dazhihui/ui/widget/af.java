...
{
  af(o paramo, ViewGroup paramViewGroup) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView.getCalltype() == null) || (paramView.getCalltype().isEmpty()) || ("0".equals(paramView.getCalltype()))) {
      ...
      {
        o.a(this.b, this.a);
        o.b(this.b).a(paramView, Boolean.valueOf(false));
      }
    }
    do
    {
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\widget\af.class
