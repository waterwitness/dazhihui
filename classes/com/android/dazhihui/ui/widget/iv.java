...
{
  iv(io paramio, ViewGroup paramViewGroup) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView.getCalltype() == null) || (paramView.getCalltype().isEmpty()) || ("0".equals(paramView.getCalltype()))) {
      ...
      {
        io.a(this.b, this.a);
        io.b(this.b).a(paramView, Boolean.valueOf(true));
      }
    }
    do
    {
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\dazhihui\ui\widget\iv.class
