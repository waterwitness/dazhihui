...
public abstract class BaseWebFragment
  extends Fragment
{
  ...
  private MyWebView.UrlLoadListener mLoadListener = new BaseWebFragment.1(this);
  ...
  private void initWebView()
  {
    ...
    for (;;)
    {
      ...
      this.mWebView.setWebChromeClient(new BaseWebFragment.2(this));
      return;
  ...
  public void loadUrl(String paramString)
  {
    ...
    if (localObject[0].equals(this.mWebView.getUrlPrefix()))
    {
      ...
      Log.e("fragment mWebView don't load complete ,cacheurl = " + paramString);
  ...
  public void preloadUrl(Activity paramActivity, String paramString)
  {
    this.mContext = paramActivity;
    mH5FilesSavePath = this.mContext.getFilesDir().getPath();
    this.mWebViewName = returnWebViewName();
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\thinkive\framework\fragment\BaseWebFragment.class
