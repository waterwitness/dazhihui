  ...
  implements IMessageHandler
{
  public String handlerMessage(Context paramContext, AppMessage paramAppMessage)
  {
    ...
    Log.d("50111 sourceModule = " + str + " appMessage content = " + paramAppMessage.getContent());
    ...
    for (;;)
    {
      ...
      continue;
      ThinkiveInitializer.getInstance().getHandler().post(new Message50111.1(this, paramAppMessage, localMyWebView));
    }
  }
}


/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\thinkive\framework\message\handler\Message50111.class
