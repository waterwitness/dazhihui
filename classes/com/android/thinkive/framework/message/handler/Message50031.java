  ...
  implements IMessageHandler
{
  public String handlerMessage(Context paramContext, AppMessage paramAppMessage)
  {
    ...
    try
    {
      localJSONObject.put("phoneOperator", NetWorkUtil.getNetWorkAgent(paramContext).getDescription());
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\thinkive\framework\message\handler\Message50031.class
