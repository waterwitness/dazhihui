  ...
  implements IMessageHandler
{
  public String handlerMessage(Context paramContext, AppMessage paramAppMessage)
  {
    ...
    Log.d("50272 sourceModule = " + str + " appMessage content = " + paramAppMessage.getContent());
    ...
    for (;;)
    {
      ...
      continue;
      ThinkiveInitializer.getInstance().getHandler().post(new Message50272.1(this, paramAppMessage, localMyWebView));
    }
  }
}


/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\com\android\thinkive\framework\message\handler\Message50272.class
