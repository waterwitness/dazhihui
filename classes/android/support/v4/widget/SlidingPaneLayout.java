  ...
  extends ViewGroup
{
  ...
  public SlidingPaneLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    bn.a(this, new an(this));
    bn.c(this, 1);
    this.q = bf.a(this, 0.5F, new ap(this, null));
    this.q.a(f1 * 400.0F);
  }
  ...
  {
    boolean bool = f();
    Object localObject = (SlidingPaneLayout.LayoutParams)this.h.getLayoutParams();
    int i1;
    label43:
    int i2;
    if (((SlidingPaneLayout.LayoutParams)localObject).c) {
      if (bool)
      {
  ...
  private void a(int paramInt)
  {
    ...
    label149:
    for (i2 = localLayoutParams.rightMargin;; i2 = localLayoutParams.leftMargin)
    {
      this.i = ((i1 - (i2 + paramInt)) / this.k);
      if (this.m != 0) {
        a(this.i);
      }
  ...
  private void a(View paramView, float paramFloat, int paramInt)
  {
    ...
    if ((paramFloat > 0.0F) && (paramInt != 0))
    {
      ...
      if (bn.g(paramView) != 2) {
        bn.a(paramView, 2, localLayoutParams.d);
      }
      g(paramView);
    }
    ...
    paramView = new ao(this, paramView);
  ...
  boolean a(float paramFloat, int paramInt)
  {
    ...
    for (paramInt = (int)(getWidth() - (i1 + paramInt + this.k * paramFloat + i2)); this.q.a(this.h, paramInt, this.h.getTop()); paramInt = (int)(localLayoutParams.leftMargin + paramInt + this.k * paramFloat))
    {
      a();
      bn.d(this);
      return true;
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      for (i1 = 0;; i1 = 1)
      {
        ...
        this.n = f1;
        this.o = f2;
        if ((!this.q.b(this.h, (int)f1, (int)f2)) || (!e(this.h))) {
          break label164;
        }
      }
  ...
  public void setPanelSlideListener(aq paramaq)
  {
    this.p = paramaq;
  }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v4\widget\SlidingPaneLayout.class
