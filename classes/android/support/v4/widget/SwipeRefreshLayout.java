  ...
  implements at, av
{
  ...
  private int L;
  private boolean M;
  private Animation.AnimationListener N = new aw(this);
  private final Animation O = new bb(this);
  private final Animation P = new bc(this);
  protected int a;
  protected int b;
  private View d;
  private be e;
  ...
  private float i;
  private final android.support.v4.view.aw j;
  private final au k;
  ...
  public SwipeRefreshLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.h = this.I;
    this.j = new android.support.v4.view.aw(this);
    this.k = new au(this);
  ...
  {
    paramInt = ak.a(paramMotionEvent, paramInt);
    if (paramInt < 0) {
      return -1.0F;
    }
    return ak.d(paramMotionEvent, paramInt);
  }
  ...
  private Animation a(int paramInt1, int paramInt2)
  {
    ...
    az localaz = new az(this, paramInt1, paramInt2);
    localaz.setDuration(300L);
    this.z.a(null);
    this.z.clearAnimation();
    this.z.startAnimation(localaz);
    return localaz;
  }
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if (ak.b(paramMotionEvent, i1) == this.u) {
      if (i1 != 0) {
        break label33;
      }
    }
    ...
    for (i1 = 1;; i1 = 0)
    {
      this.u = ak.b(paramMotionEvent, i1);
      return;
    }
  }
  ...
  private void b()
  {
    this.z = new a(getContext(), -328966, 20.0F);
  ...
  private void c(int paramInt, Animation.AnimationListener paramAnimationListener)
  {
    this.a = paramInt;
    if (c()) {}
    for (this.B = this.C.getAlpha();; this.B = bn.q(this.z))
    {
      this.H = new bd(this);
  ...
  private void setAnimationProgress(float paramFloat)
  {
    ...
    bn.d(this.z, paramFloat);
    bn.e(this.z, paramFloat);
  }
  ...
  public boolean a()
  {
    ...
    if (Build.VERSION.SDK_INT < 14)
    {
      ...
      if ((bn.b(this.d, -1)) || (this.d.getScrollY() > 0)) {
        bool = true;
      }
      return bool;
    }
    return bn.b(this.d, -1);
  }
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.u = ak.b(paramMotionEvent, 0);
      this.t = false;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 6: 
      for (;;)
      {
        ...
        this.t = false;
        continue;
        i1 = ak.a(paramMotionEvent, this.u);
        if (i1 < 0)
        {
          Log.e(c, "Got ACTION_MOVE event but have an invalid active pointer id.");
          return false;
        }
        f1 = (ak.d(paramMotionEvent, i1) - this.r) * 0.5F;
        if (this.t)
        {
          if (f1 <= 0.0F) {
            break;
    ...
    float f1 = ak.d(paramMotionEvent, i1);
    float f2 = this.r;
    this.t = false;
    b((f1 - f2) * 0.5F);
    this.u = -1;
  ...
  {
    if (((Build.VERSION.SDK_INT < 21) && ((this.d instanceof AbsListView))) || ((this.d != null) && (!bn.u(this.d)))) {
      return;
    }
  ...
  public void setOnRefreshListener(be parambe)
  {
    this.e = parambe;
  }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v4\widget\SwipeRefreshLayout.class
