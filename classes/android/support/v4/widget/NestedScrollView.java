  ...
  implements at, av, bh
{
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if (ak.b(paramMotionEvent, i1) == this.q) {
      if (i1 != 0) {
        break label63;
      }
    }
    ...
    for (i1 = 1;; i1 = 0)
    {
      this.f = ((int)ak.d(paramMotionEvent, i1));
      this.q = ak.b(paramMotionEvent, i1);
      if (this.k != null) {
        this.k.clear();
      }
      return;
  ...
  private void g()
  {
    if (bn.a(this) != 2)
    {
      if (this.d == null)
      {
        ...
        this.d = new q(localContext);
        this.e = new q(localContext);
      }
      return;
    }
    this.d = null;
  ...
  {
    if ((ak.d(paramMotionEvent) & 0x2) != 0) {
    ...
    for (;;)
    {
      ...
      if (!this.j)
      {
        float f1 = ak.e(paramMotionEvent, 9);
        if (f1 != 0.0F)
        {
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i1 != -1)
      {
        int i2 = ak.a(paramMotionEvent, i1);
        if (i2 == -1)
        {
        ...
        {
          i1 = (int)ak.d(paramMotionEvent, i2);
          if ((Math.abs(i1 - this.f) > this.n) && ((getNestedScrollAxes() & 0x2) == 0))
          {
            ...
            if (paramMotionEvent != null)
            {
              ...
              {
                this.f = i1;
                this.q = ak.b(paramMotionEvent, 0);
                c();
                this.k.addMovement(paramMotionEvent);
                if (!this.c.a()) {
                  bool = true;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (this.j)
    {
      ...
      if (i2 < 0)
      {
        this.d.a(i1 / getHeight(), ak.c(paramMotionEvent, i3) / getWidth());
        if (!this.e.a()) {
          this.e.c();
        }
      }
      while ((this.d != null) && ((!this.d.a()) || (!this.e.a())))
      {
        ...
        if (i2 > i4)
        {
          this.e.a(i1 / getHeight(), 1.0F - ak.c(paramMotionEvent, i3) / getWidth());
          if (!this.d.a()) {
            this.d.c();
          }
        }
      ...
      if (this.j)
      {
        ...
        i1 = (int)bi.b(paramMotionEvent, this.q);
      ...
      break;
      a(paramMotionEvent);
      this.f = ((int)ak.d(paramMotionEvent, ak.a(paramMotionEvent, this.q)));
      break;
    }
  }
  ...
  public void setOnScrollChangeListener(ad paramad)
  {
    this.A = paramad;
  }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v4\widget\NestedScrollView.class
