...
public class bf
{
  private static final Interpolator v = new bg();
  private int a;
  private int b;
  private int c = -1;
  private float[] d;
  ...
  private final Runnable w = new bh(this);
  
  private bf(Context paramContext, ViewGroup paramViewGroup, bi parambi)
  {
  ...
  public static bf a(ViewGroup paramViewGroup, float paramFloat, bi parambi)
  {
    paramViewGroup = a(paramViewGroup, parambi);
    paramViewGroup.b = ((int)(paramViewGroup.b * (1.0F / paramFloat)));
    return paramViewGroup;
  }
  
  public static bf a(ViewGroup paramViewGroup, bi parambi)
  {
    return new bf(paramViewGroup.getContext(), paramViewGroup, parambi);
  }
  ...
  private void g()
  {
    ...
    a(a(android.support.v4.view.bi.a(this.l, this.c), this.n, this.m), a(android.support.v4.view.bi.b(this.l, this.c), this.n, this.m));
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    return a(paramInt1, paramInt2, (int)android.support.v4.view.bi.a(this.l, this.c), (int)android.support.v4.view.bi.b(this.l, this.c));
  }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v4\widget\bf.class
