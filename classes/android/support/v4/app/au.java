...
class au
{
  ...
  private static void a(Transition paramTransition, az paramaz)
  {
    if (paramTransition != null) {
      paramTransition.setEpicenterCallback(new ax(paramaz));
    }
  }
  ...
  public static void a(View paramView1, View paramView2, Object paramObject1, ArrayList<View> paramArrayList1, Object paramObject2, ArrayList<View> paramArrayList2, Object paramObject3, ArrayList<View> paramArrayList3, Object paramObject4, ArrayList<View> paramArrayList4, Map<String, View> paramMap)
  {
    ...
    if (paramObject4 != null) {
      paramView1.getViewTreeObserver().addOnPreDrawListener(new ay(paramView1, (Transition)paramObject1, paramArrayList1, (Transition)paramObject2, paramArrayList2, (Transition)paramObject3, paramArrayList3, paramMap, paramArrayList4, (Transition)paramObject4, paramView2));
    }
  }
  ...
  {
    ((Transition)paramObject).setEpicenterCallback(new av(c(paramView)));
  }
  ...
  public static void a(Object paramObject1, Object paramObject2, View paramView1, ba paramba, View paramView2, az paramaz, Map<String, String> paramMap, ArrayList<View> paramArrayList1, Map<String, View> paramMap1, Map<String, View> paramMap2, ArrayList<View> paramArrayList2)
  {
    if ((paramObject1 != null) || (paramObject2 != null))
    {
      ...
      if (paramba != null) {
        paramView1.getViewTreeObserver().addOnPreDrawListener(new aw(paramView1, (Transition)paramObject1, paramView2, paramba, paramMap, paramMap2, paramArrayList1));
      }
      a((Transition)paramObject1, paramaz);
    }
  }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v4\app\au.class
