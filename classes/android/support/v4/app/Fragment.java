  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  af mChildFragmentManager;
  ViewGroup mContainer;
  int mContainerId;
  boolean mDeferStart;
  boolean mDetached;
  Object mEnterTransition = null;
  da mEnterTransitionCallback = null;
  Object mExitTransition = null;
  da mExitTransitionCallback = null;
  int mFragmentId;
  af mFragmentManager;
  boolean mFromLayout;
  boolean mHasMenu;
  ...
  public final ad getChildFragmentManager()
  {
    if (this.mChildFragmentManager == null)
    {
  ...
  public final ad getFragmentManager()
  {
  ...
  public LayoutInflater getLayoutInflater(Bundle paramBundle)
  {
    ...
    z.a(paramBundle, this.mChildFragmentManager.v());
    return paramBundle;
  }
  
  public bb getLoaderManager()
  {
    if (this.mLoaderManager != null) {
  ...
  void instantiateChildFragmentManager()
  {
    ...
    this.mChildFragmentManager.a(this.mHost, new u(this), this);
  }
  ...
  public void onAttach(Context paramContext)
  {
    this.mCalled = true;
    if (this.mHost == null) {}
    for (paramContext = null;; paramContext = this.mHost.h())
    {
  ...
  void performActivityCreated(Bundle paramBundle)
  {
    ...
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onActivityCreated()");
    }
    if (this.mChildFragmentManager != null) {
      this.mChildFragmentManager.m();
    }
  ...
  void performCreate(Bundle paramBundle)
  {
    ...
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onCreate()");
    }
    if (paramBundle != null)
    {
  ...
  void performDestroy()
  {
    ...
    onDestroy();
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onDestroy()");
    }
  }
  ...
  void performDestroyView()
  {
    ...
    onDestroyView();
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onDestroyView()");
    }
    if (this.mLoaderManager != null) {
  ...
  void performPause()
  {
    ...
    onPause();
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onPause()");
    }
  }
  ...
  void performResume()
  {
    ...
    onResume();
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onResume()");
    }
    if (this.mChildFragmentManager != null)
    {
      this.mChildFragmentManager.o();
  ...
  void performStart()
  {
    ...
    onStart();
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onStart()");
    }
    if (this.mChildFragmentManager != null) {
      this.mChildFragmentManager.n();
    }
  ...
  void performStop()
  {
    ...
    onStop();
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onStop()");
    }
  }
  ...
  final void restoreViewState(Bundle paramBundle)
  {
    ...
    if (!this.mCalled) {
      throw new db("Fragment " + this + " did not call through to super.onViewStateRestored()");
    }
  }
  ...
  {
    this.mEnterTransitionCallback = paramda;
  }
  ...
  {
    this.mExitTransitionCallback = paramda;
  }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v4\app\Fragment.class
