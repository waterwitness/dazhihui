  ...
  implements bg, bh
{
  ...
  {
    this.c.add(cl.a(this.a, paramcf));
  }
  
  public Notification b()
  {
    Notification localNotification = this.a.build();
    Object localObject = cl.a(localNotification);
    ...
    localObject = cl.a(this.c);
    if (localObject != null) {
      cl.a(localNotification).putSparseParcelableArray("android.support.actionExtras", (SparseArray)localObject);
    }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v4\app\cm.class
