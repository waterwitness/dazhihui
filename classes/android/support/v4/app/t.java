  ...
  implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener
{
  ...
  void dismissInternal(boolean paramBoolean)
  {
    ...
    at localat = getFragmentManager().a();
    localat.a(this);
    if (paramBoolean)
    {
      localat.b();
  ...
  public int show(at paramat, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    paramat.a(this, paramString);
    this.mViewDestroyed = false;
    this.mBackStackId = paramat.a();
    return this.mBackStackId;
  }
  
  public void show(ad paramad, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    paramad = paramad.a();
    paramad.a(this, paramString);
    paramad.a();
  }
}


/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v4\app\t.class
