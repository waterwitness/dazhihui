...
final class g
{
  ...
  static long a(RandomAccessFile paramRandomAccessFile, h paramh)
  {
    ...
    long l = paramh.b;
    paramRandomAccessFile.seek(paramh.a);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        if (paramRandomAccessFile.readInt() == i)
        {
          ...
          paramRandomAccessFile.skipBytes(2);
          h localh = new h();
          localh.b = (Integer.reverseBytes(paramRandomAccessFile.readInt()) & 0xFFFFFFFF);
          localh.a = (Integer.reverseBytes(paramRandomAccessFile.readInt()) & 0xFFFFFFFF);
          return localh;
        }
        l3 = l2 - 1L;
        l2 = l3;
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\multidex\g.class
