...
class d
{
  ...
  View a(int paramInt1, int paramInt2)
  {
    ...
    while (i < j)
    {
      ...
      bk localbk = this.a.b(localView);
      if ((localbk.getLayoutPosition() == paramInt1) && (!localbk.isInvalid()) && (!localbk.isRemoved()) && ((paramInt2 == -1) || (localbk.getItemViewType() == paramInt2))) {
        return localView;
      }
      i += 1;
    }
...
/* Location:              E:\apk\dazhihui2\classes-dex2jar.jar!\android\support\v7\widget\d.class
